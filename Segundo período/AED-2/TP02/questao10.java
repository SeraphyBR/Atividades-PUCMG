...
{//Inicio classe questao01
    ...
    {//Inicio main
        ...
        {//Inicio try
            ...
            listaInstituicao.ordenarCodigoMunicipio(10);//Ordena a lista com base no codigo das IES
...
{//Inicio classe Lista
    ...
    /**
     * Algoritmo de ordenacao parcial Heapsort Invertido com base no codigo
     * do municipio.
     * @param k Numero de elementos a serem ordenados.
     * @throws Exception Se k for menor que 1 ou maior que o total de elementos.
     */
    public void ordenarCodigoMunicipio(int k) throws Exception
    {//Inicio ordenarCodigo
        ...
        //Construcao do heap
        int tamHeap = 2;
        for(tamHeap = 2; tamHeap <= numElementos; tamHeap++){
