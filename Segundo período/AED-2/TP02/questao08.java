...
{//Inicio classe questao01
    ...
    {//Inicio main
        ...
        {//Inicio try
            ...
            listaInstituicao.ordenarCodigoParcial(10);//Ordena a lista com base no codigo das IES
            tempoFinal = System.currentTimeMillis();

            listaInstituicao.mostrarParcial(10);
        }//Fim try
...
{//Inicio classe Lista
     ...
     */
    public void mostrarParcial(int k) throws Exception
    {//Inicio mostrar
     ...
     */
    public void ordenarCodigoParcial(int k) throws Exception
