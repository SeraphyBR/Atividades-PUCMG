...
{//Inicio classe questao01
    ...
    {//Inicio main
        ...
        {//Inicio try
            ...
            FilaInstituicao filaInstituicao = new FilaInstituicao(5);
...
/**
 * Fila estatica de IES
 * @author Luiz Junio Veloso Dos Santos
 * @version 1.0
 */
class FilaInstituicao
{//Inicio classe FilaInstituicao
     ...
     */
    public FilaInstituicao(int tamanho){
    ...
    {//Inicio remover
        ...
        Instituicao removido = array[primeiro];
        numElementos--;
