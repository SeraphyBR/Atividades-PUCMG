...
{//Inicio classe questao01
    ...
    {//Inicio main
        ...
        Arq.openWrite("624037_avl.txt");//Abrindo arquivo de Log para escrita
...
{//Inicio classe No Instituicao
     ...
     */
    private No(Instituicao elemento, No esq, No dir, int nivel){
    ...
    /**
     * Metodo que calcula o numero de niveis a partir de um vertice.
     * @return O proprio No com o nivel modificado;
     */
    public No setNivel(){
    ...
    /**
     * Metodo para obter o numero de niveis a partir de um vertice.
     * @return Zero se for um No nulo, senão retorna o nivel do No.
     */
...
/**
 * Arvore binaria de pesquisa Balanceada (AVL) 
 * @author Luiz Junio Veloso Dos Santos 
 */
class ArvoreAVL
{//Inicio classe ArvoreAVL
    ...
    {//Inicio balancear
        if(i != null){
            ...
            else throw new Exception("Erro no fator de balanceamento (" + fator + ") invalido!");
        }
