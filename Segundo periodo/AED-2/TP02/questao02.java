...
{//Inicio classe questao01
    ...
    {//Inicio main
        ...
        {//Inicio try
            ...
            Pilha pilhaInstituicao = new Pilha();//criando uma pilha de instituicoes
...
{//Inicio classe Pilha
    ...
    {//Inicio remover
        if(topo == null || this.numElementos == 0){
            throw new Exception("Erro ao remover!");
        }

        Instituicao removido = topo.elemento;
        Celula tmp = topo;
        topo = topo.prox;
        tmp.prox = null;
        tmp = null;
