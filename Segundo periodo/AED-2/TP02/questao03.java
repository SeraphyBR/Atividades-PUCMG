...
{//Inicio classe questao01
    ...
    {//Inicio main
        ...
        {//Inicio try
            ...
            Fila filaInstituicao = new Fila(5);

            Instituicao temp;
            for(int cont = 0; cont < i; cont++){
                temp = new Instituicao(registro[linha[cont]]);
                if(!filaInstituicao.isCheia()){
                    filaInstituicao.inserir(temp.getClone());
                }
                else{
                    filaInstituicao.remover();
                    filaInstituicao.inserir(temp.getClone());
                }
            ...
            {//Inicio for
                ...
                {//Inicio switch
                    case "I"://insercao
                        ...
                        temp = new Instituicao(registro[linhaArquivo]);
                        if(!filaInstituicao.isCheia()){
                            filaInstituicao.inserir(temp.getClone());
                        }
                        else{
...
{//Inicio classe Fila
    ...
    /**
     * Construtor da classe que cria uma fila sem elementos (somente no cabeça)
     */
    public Fila(){
        this(5);
    }
    ...
    {//Inicio inserir
        if(this.isCheia()){
            Instituicao tmp = this.remover();
        }
        this.ultimo.prox = new Celula(instituicao);
    ...
    {//Inicio remover
        ...
        Instituicao removido = primeiro.elemento;
        tmp.prox = null;
        tmp = null;
        this.numElementos--;
    ...
    /**
     * Mostra as instituicoes na fila
     */
    public void mostrar()
    {//Inicio mostrar
     ...
     * @return Um boolean indicando se a fila esta vazia
     */
    ...
    {//Inicio getMediaDespesaDocente
        ...
        {//Inicio if
            for(Celula i = primeiro.prox; i != null; i = i.prox){
                somaDespesas += i.elemento.getDespesaDocente();
            }
