...
{//Inicio classe questao01
    ...
    {//Inicio main
        ...
        {//Inicio try
            ...
            listaInstituicao.ordenarLivro();//Ordena a lista com base na quantidade de livros eletronicos
        ...
        Arq.openWrite("matrícula_bolha.txt");//Abrindo arquivo de Log para escrita
...
{//Inicio classe Lista
    ...
    /**
     * Ordenacao bolha com base no atributo Livro.
     */
    public void ordenarLivro() throws Exception
    {//Inicior ordenarLivro
